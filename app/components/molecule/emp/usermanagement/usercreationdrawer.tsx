...
const UserCreationDrawer = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <>
      {isOpen && <div className="fixed inset-0 backdrop-blur-xs z-40" onClick={() => setIsOpen(false)} />}
      ...
      >
        ...
        <div className="p-6 h-full overflow-y-auto">
          <form onSubmit={handleSubmit} className="space-y-6">
            {["Full Name", "Email", "Phone", "Username", "Password","Role" ].map((field) => (
              <div key={field}>
                ...
                <input
                  ...
                  required={field === "Role" || field === "Password" || field === "Username" || field === "Email" ? true : false}
                />
