...
import { cn } from "~/components/atom/utils";
...
export function FeaturesSection() {
  ...
  return (
    <div className="z-20 py-10 lg:py-20 max-w-7xl mx-auto">
      <div className="px-8">
        ...
        <p className="text-sm lg:text-base  max-w-2xl  my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          From img generation to video generation, Everything AI has APIs for
