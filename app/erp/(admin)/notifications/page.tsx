      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{notifications.filter((n) => n.type === "system").length}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{notifications.filter((n) => n.type === "task").length}</div>
          ...
          <TabsContent value="system">
            <Card>
              <CardHeader>
                ...
                <CardDescription>View all system-related notifications</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {notifications
          ...
          <TabsContent value="user">
            <Card>
              <CardHeader>
                ...
                <CardDescription>View all user-related notifications</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {notifications
          ...
          <TabsContent value="task">
            <Card>
              <CardHeader>
                ...
                <CardDescription>View all task-related notifications</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {notifications
          ...
          <TabsContent value="academic">
            <Card>
              <CardHeader>
                ...
                <CardDescription>View all academic-related notifications</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {notifications
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Configure which types of notifications to receive</p>
                </div>
                <Button variant="outline" size="sm">
                  Configure
                </Button>
